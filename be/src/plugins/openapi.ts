...
const generatedCrudSuccessExamples: Array<[string, Record<string, unknown>]> = [
  ...
  ['IssuanceOrderLines', withCrudMetadata({ id: 'issue-line-1001', issuanceOrderId: 'issue-1001', collectionUnitId: 'cu-1001', legacyHetId: 'HET-1001', legacyHetNumber: 'HET-1001', parcelTrackingNumber: 'TRACK-1001' })],
  ...
  ['CollectionReceiptLines', withCrudMetadata({ id: 'receipt-line-1001', collectionReceiptId: 'receipt-1001', collectionUnitId: 'cu-1001', conditionStatus: 'intact', acceptanceStatus: 'accepted', resultingHetId: 'het-1001', discrepancyReason: null })],
...
function fallbackRequestExample(operation: OpenAPIV3.OperationObject) {
  ...
  const examples: Array<[string, Record<string, unknown>]> = [
    ...
    ['IssuanceOrderLines', { issuanceOrderId: 'issue-1001', collectionUnitId: 'cu-1001', legacyHetId: 'HET-1001', legacyHetNumber: 'HET-1001', parcelTrackingNumber: 'TRACK-1001' }],
    ...
    ['CollectionReceiptLines', { collectionReceiptId: 'receipt-1001', collectionUnitId: 'cu-1001', conditionStatus: 'intact', acceptanceStatus: 'accepted', resultingHetId: 'het-1001', discrepancyReason: null }],
