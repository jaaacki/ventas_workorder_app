...
import { LayoutDashboard, Users, Shield, Menu, LogOut, Settings2, Factory, Search, Boxes, Warehouse } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Inventory', href: '/dashboard/inventory', icon: Warehouse, roles: ['owner', 'admin', 'user'] },
